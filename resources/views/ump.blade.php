<title>UMP E-Comm</title>

<x-guest-layout>

    <div class="absolute top-0 left-0 m-4">
        <img src="{{ url('storage/ump/logo-ump.png') }}" alt="ump" class="h-12" />
    </div>

    <x-jet-authentication-card>
        <x-slot name="logo">
            <a href="https://ump.edu.my/en">
                <img src="{{ url('storage/ump/logo-ecomm.png') }}" alt="ecomm" class="block h-12 mx-auto mb-6" />
            </a>
        </x-slot>
        ...
        <form method="POST">
            ...
            <div class="mt-4 relative">
                ...
                <div class="relative">
                    ...
                    <x-jet-input id="matric_number" class="pl-8 block mt-1 w-full" type="text" name="matric_number" :value="old('matric_number')" required />
                </div>
            </div>
